...
![Slide 79 - Créer une page complète](../slide_79.png)

D'après le support de formation, pour créer une page complète avec Copilot :
...
> 📷 **Capture d'écran à insérer ici** : nouvelle page vierge ajoutée et renommée.
...
> 📷 **Capture d'écran à insérer ici** : page générée avec les cards, slicers et visual bien identifiés.
...
> 📷 **Capture d'écran à insérer ici** : volet Visualisations d'une carte avec le champ et l'agrégation vérifiés.
...
> 📷 **Capture d'écran à insérer ici** : test d'un filtre sur les slicers avec mise à jour des visuels.
...
> 📷 **Capture d'écran à insérer ici** : ajout d'un slicer supplémentaire via un nouveau prompt.
...
> 📷 **Capture d'écran à insérer ici** : page finale mise en forme avec titre.
